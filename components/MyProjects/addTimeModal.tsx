   ...
   return (
      <TouchableWithoutFeedback  onPress={() => Keyboard.dismiss()}>
         ...
         <View style={{backgroundColor: backgroundLighter, borderRadius: 20, ...styles.contentBox}}>
            ...
            <ThemedInput validate={validateTimeToAdd} setTextAndState={timeToAddCallback} leftIcon="time-sharp" validation={true} placeholder="Hours.." darkMode={darkMode} type="number-pad"/>
